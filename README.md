...
I build autonomous AI-agent systems, web tools, and video automation pipelines. Based in Norway. Most of my projects are designed to run locally with minimal setup — no cloud subscriptions, no external dependencies unless necessary.
...
Open to freelance work. The fastest way to reach me is by opening an issue on any of my repos.
